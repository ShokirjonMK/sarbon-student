                ...
                : checkFileFormat(file) === "ppt" || checkFileFormat(file) === "doc" || checkFileFormat(file) === "excel" ?
                  <div>
                    <div className="flex-between flex-wrap gap-2 mb-2">
                      <div className="d-f">
                        {
                          checkFileFormat(file) === "excel" ? <DocumentTableFilled fontSize={20} color="#2F54EB" />
                            : checkFileFormat(file) === "zip" ? <FolderZipFilled fontSize={20} color="#2F54EB" />
                              : <DocumentFilled fontSize={20} color="#2F54EB" />
                        }
